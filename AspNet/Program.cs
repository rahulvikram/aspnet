...
// Filter pipeline: Add a filter to the MVC filter pipeline
builder.Services.AddControllersWithViews(options =>
{
    options.Filters.Add<LogRequestFilter>(); // Register globally
});

// ensure that the app is able to use logging
